...
interface AuthorizationI {
    ...
    function approve(address grantee, uint256 amount, string[] calldata methods) external returns (bool approved);
    ...
    function revoke(address grantee, string[] calldata methods) external returns (bool revoked);
    ...
    event Approval(address indexed grantee, address indexed granter, string[] methods, uint256 value);
    ...
    /// @param methods The message type URLs of the methods for which the approval is set.
    event Revocation(address indexed grantee, address indexed granter, string[] methods);
    ...
    event AllowanceChange(address indexed grantee, address indexed granter, string[] methods, uint256[] values);
}

...
async function main() {
    ...
    const CurveLiteTwocryptoswapProxy = await deployCurveLiteTwocryptoswapProxy(deployer, await tacSAFactory.getAddress(), await tacContracts.crossChainLayer.getAddress());
